...
def write_to_log(message: str):
    """Write a message to the log.txt file in the workbench directory.
...
async def create_thread() -> str:
    """Create a new conversation thread for aixai.
    Always call this tool before starting a new conversation.
...
async def run_agent(thread_id: str, user_input: str) -> str:
    """Run the AIxAI agent with user input.
    ...
    After you receive the code from AIxAI, always implement it into the codebase unless asked not to.
