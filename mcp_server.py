...
async def create_thread() -> str:
    """Create a new conversation thread for Agenteer.
    Always call this tool before invoking Agenteer for the first time in a conversation.
...
async def run_agent(thread_id: str, user_input: str) -> str:
    """Run the Agenteer agent with user input.
